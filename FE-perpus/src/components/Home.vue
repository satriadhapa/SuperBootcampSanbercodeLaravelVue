<template>
  <div class="container mx-auto p-6 bg-gray-100 min-h-screen">
    <h1 class="text-3xl font-extrabold mb-6 text-center text-blue-700">Welcome to the Library</h1>
    
    
    <h2 class="text-2xl font-semibold mb-4 text-gray-700 text-center">Books</h2>
    ...
    <br>
    <h2 class="text-2xl font-semibold mb-4 text-gray-700 text-center">Categories</h2>
